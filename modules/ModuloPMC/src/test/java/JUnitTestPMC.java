...
public class JUnitTestPMC {
    ...
    public void test1(){
        ...
        System.out.println(TipoFuncion.getTipoFuncion("Lineal", 1.25));
        System.out.println(TipoFuncion.getTipoFuncion("Sigmoidal", 1.25));
        
        System.out.println("-0.25");
        System.out.println(TipoFuncion.getTipoFuncion("Lineal", -0.25));
        System.out.println(TipoFuncion.getTipoFuncion("Sigmoidal", -0.25));
        
        System.out.println("-2.55");
        System.out.println(TipoFuncion.getTipoFuncion("Lineal", -2.55));
        System.out.println(TipoFuncion.getTipoFuncion("Sigmoidal", -2.55));
    }
}
